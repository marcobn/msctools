...
# Example of threading unction that uses the result of the hand detection
# Save trajectory of a chosen landmark in a given hand
Lx = []
Ly = []
threading.Thread(target=lndmrk_traj,args=('Left',8,Lx,Ly)).start()
Rx = []
Ry = []
threading.Thread(target=lndmrk_traj,args=('Right',8,Rx,Ry)).start()
